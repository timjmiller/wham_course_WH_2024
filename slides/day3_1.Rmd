...
Here we use the `jitter` function to create the default number of initial parameter vectors and refit the model for each

.pull-left[
The fitted model is saved as an RDS prior to calling `jitter`.
```{r, eval = FALSE}
jitter_res <- jitter(fit_RDS = file.path("temp", "day_3_1_fit_6.RDS"), 
