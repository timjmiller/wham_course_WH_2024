...
* **See the simulation vignette of the this wham version for greater details**
---
...
* Here is an input where instead assumes a logistic normal (treating 0s as missing).
